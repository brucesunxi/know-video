...
import { inspectRenderedOutput } from "../worker/render-output-quality.mjs";
...
await inspectRenderedOutput(outputBody, {
  duration: (Math.min(frameEnd, composition.durationInFrames - 1) - frameStart + 1) / composition.fps,
