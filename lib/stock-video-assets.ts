...
const CHINESE_STOCK_TERMS: Array<[RegExp, string]> = [
  ...
  [/工地|施工|安全帽|防护装备|入场检查|高空作业|作业安全|construction|job[- ]?site|worksite|site safety|safety briefing|pre[- ]?entry|protective equipment|hard hat|safety harness|\bppe\b/iu, "construction workers safety equipment inspection"],
  [/工地|施工|安全帽|防护装备|入场检查|高空作业|作业安全|construction|job[- ]?site|worksite|site safety|safety briefing|pre[- ]?entry|protective equipment|hard hat|safety harness|\bppe\b/iu, "construction worker checking hard hat vest harness"],
  [/工地|施工|安全帽|防护装备|入场检查|高空作业|作业安全|construction|job[- ]?site|worksite|site safety|safety briefing|pre[- ]?entry|protective equipment|hard hat|safety harness|\bppe\b/iu, "construction team safety briefing daylight"],
  [/企业安全|公司安全|办公安全|安全培训|安全意识|员工培训|信息安全|网络安全|corporate security|security training|security awareness|employee training|workplace training|cybersecurity/iu, "corporate security awareness training employees office"],
  [/企业安全|公司安全|办公安全|安全培训|安全意识|员工培训|信息安全|网络安全|corporate security|security training|security awareness|employee training|workplace training|cybersecurity/iu, "office employees security training workshop"],
  [/企业安全|公司安全|办公安全|安全培训|安全意识|员工培训|信息安全|网络安全|corporate security|security training|security awareness|employee training|workplace training|cybersecurity/iu, "business team workplace training presentation"],
