        ...
        setMessages([
          ...data.messages,
          {
            ...
            content: data.engine === "openai"
              ? "This storyboard was generated by the AI model and saved to Neon."
              : "This storyboard was generated by the local planning engine and saved to Neon. Add OPENAI_API_KEY to switch to model generation."
          }
        ]);
        setSelectedScene(1);
